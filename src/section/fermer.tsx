  ...
  return (
    <Container className='mt-[40px]  flex md:flex-row flex-col-reverse  gap-4'>
        <div className='w-full bg-white  fermet opacity-0  rounded-2xl border-solid border-[#53B606] border pt-[40px] pb-[88px] px-[35px] '>
            ...
            <p className='flex items-start gap-4 font-medium leading-[18px] md:text-[16px] md:leading-[20px] xl:text-[18px] xl:leading-[26px] mt-[16px] w-full maxm-w-[735px]' ><span className='w-[32px] min-[32px]'><AgroIcons1/></span>{t('fermerText1')}</p>
            <p className='flex items-start gap-4 font-medium leading-[18px] md:text-[16px] md:leading-[20px] xl:text-[18px] xl:leading-[26px] mt-[16px] w-full maxm-w-[735px]' ><span className='w-[32px] min-[32px]'><AgroIcons2/> </span> {t('fermerText2')}</p>
            <p className='flex items-start gap-4 font-medium leading-[18px] md:text-[16px] md:leading-[20px] xl:text-[18px] xl:leading-[26px] mt-[16px] w-full maxm-w-[735px]' ><span className='w-[32px] min-[32px]'><AgroIcons3/> </span>{t('fermerText3')}</p>
        </div>
